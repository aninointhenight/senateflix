...
export default function DisclaimerPopup() {
  ...
  return (
    ...
    >
      <div className="bg-[#181818] border border-gray-700/60 rounded-lg w-full max-w-sm mx-4 p-8 text-center shadow-2xl">
        {/* Logo */}
        ...
        <button
          onClick={dismiss}
          className="bg-sf-red hover:bg-red-700 active:scale-95 text-white font-bold text-sm uppercase tracking-wider px-10 py-3 rounded transition-all"
        >
          I Understand
        </button>
      </div>
